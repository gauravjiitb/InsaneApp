...
#     class Meta:
#         model = Inclusion
#         fields = ('quote','item_type','name','details','city','transport','hotel','transfer','sightseeing','visa','insurance','other_type',
#                     'day','nights','airline','room_type','price','fixed_package_item','freeze','optional','include')
#
#     def clean(self):
#         cleaned_data = super().clean()
...
#         item_type = cleaned_data.get("item_type")
#         details = cleaned_data.get("details")
#         transport = cleaned_data.get("transports")
#         optional = cleaned_data.get("optional")
#         city = cleaned_data.get("city")
#         transfer = cleaned_data.get("transfers")
#         sightseeing = cleaned_data.get("sightseeings")
#         visa = cleaned_data.get("visas")
#         insurance = cleaned_data.get("insurance")
#         name = cleaned_data.get("name")
#         other_type = cleaned_data.get("other_type")
#
